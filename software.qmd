...
pkg_data <- pkg_data |>
  ...
  rename(c("Package" = "package", "Released" = "released", "Last update" = "last_update", "Version" = "version", "Title" = "title", "Downloads" = "downloads", "Hexsticker" = "hexsticker", "URL" = "url")) |>
  flextable(cwidth = 2) 
...
cran_github <- pkgmeta::get_meta(
  ...
  rename(c("Package" = "package", "Date" = "date", "Version" = "version", "Title" = "title", "Hexsticker" = "hexsticker", "URL" = "url"))
