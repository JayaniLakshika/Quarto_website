...
for _, data in yaml_data.items():
    ...
    authors = [aut if aut != "me" else "<strong>Jayani P. G. Lakshika</strong>" for aut in authors]
...
yaml_data = yaml.safe_load(open("abstract.yaml"))
...
for data in yaml_data[::-1]:
    ...
    display(Markdown(author_str))
    buttons = []
    if "PDF" in data:
        buttons.append(button(data['PDF'], "PDF", "bi-file-earmark-pdf"))
